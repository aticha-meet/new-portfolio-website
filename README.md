...
## เปลี่ยนจำนวน Projects ที่แสดง

แก้ `limit` ใน `config/projects.ts` จุดเดียว: `6` แสดงไม่เกิน 6 การ์ดต่อหมวด, `4` แสดงไม่เกิน 4 หรือ `null` แสดงทั้งหมด ข้อมูลโปรเจกต์ยังเก็บครบใน `lib/data.ts`; component กรองหมวดจากทั้งหมดแล้วค่อย slice ก่อน map เท่านั้น ป้าย All projects แสดงจำนวนข้อมูลทั้งหมด และตัวนับบอกจำนวนที่แสดงจริง
